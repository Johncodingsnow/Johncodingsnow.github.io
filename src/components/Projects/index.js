...
const Projects = ({openModal,setOpenModal}) => {
    ...
    return (
        <Container id="projects">
          ...
          <Divider />
          {toggle === 'SQL' ?
            <ToggleButton active value="SQL" onClick={() => setToggle('SQL')}>SQL</ToggleButton>
            :
            <ToggleButton value="SQL" onClick={() => setToggle('SQL')}>SQL</ToggleButton>
          }
          <Divider />
          {toggle === 'machine learning' ?
            <ToggleButton active value="machine learning" onClick={() => setToggle('machine learning')}>Python</ToggleButton>
            :
            <ToggleButton value="machine learning" onClick={() => setToggle('machine learning')}>Python</ToggleButton>
          }
            </ToggleGroup>
            <CardContainer>
            {toggle === 'all' && projects
